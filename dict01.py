...
# .get()을 사용하면 ㅇ벗다고 안내만 하고 에러는 발생하지 않습니다
print(dic.get["귀뚜라미"])

# None대신 없을때 출력할 멘트를 지정할 수도 있습니다
